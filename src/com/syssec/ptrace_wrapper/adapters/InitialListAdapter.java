...
public class InitialListAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final List<String> values;
    public InitialListAdapter(Context context, List<String> values) {
   
    	super(context, R.layout.activity_ptrace, values);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.activity_ptrace, parent, false);
        TextView appName = (TextView) rowView.findViewById(R.id.ptracetext);
